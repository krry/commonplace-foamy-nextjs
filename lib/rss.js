...
const feed = new RSS({
	title: 'Commonplace of an Atmanaut',
	description:
		'A zettelkasten-style digital garden full of half-baked poetry and other musings.',
	site_url: 'https://commonplace.atmanaut.me',
	feed_url: 'https://commonplace.atmanaut.me/rss.xml',
	image_url: 'https://commonplace.atmanaut.me/favicons/favicon-512x512.png',
	// docs: 'https://commonplace.atmanaut.me/rss/docs.html',
	author: 'Kerrbear',
	managingEditor: 'Kerrence Snyderian',
	webMaster: 'Kerrbear',
...
function generateRss() {
	...
	matters.map(note => {
		...
		feed.item({
			...
			url: `https://commonplace.atmanaut.me/${slug}`, // link to the item
