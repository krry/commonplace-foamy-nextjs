...
We technologists build mechanisms and concoct algorithms to save ourselves time performing tasks we judge to be necessary or desirable, or [boring as Kyle Wild astutely posited](). We employ time-saving devices to increase the value of our incremental time, ideally peddling our own limited time to others at an inflated rate.
