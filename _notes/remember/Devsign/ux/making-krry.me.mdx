...
just a trim here, and a trim there:
		...
		DAEMON=<NODE_PATH>
11. Set up a *ghost* user group, make your *root* a part of the group
...
16. Safen your haven. Get an SSL certificate from some sleazy cryptographer on the virtual street corner.
