...
7. Color: be fruitful but reserved
	* no day starts bright
	* mimic mating rituals, flashes of color
	* contrast is the key, not flair
8. Media: Meaning, Pictures > Words
	* convey a deeper message, focus on nonverbal communication
	* focus on implications of visual and interactive design
9. Information: Words & Pictures
	* convey information, focus thru clear, readable language
	* information architecture is paramount
10. Feedback - less choices, less error
	* Choices introduce error. More choices introduce more error.
...
12. Aim for the majority
	* be messier and larger, rather than constructed and complete
13. Technology is hard to understand
	* Don't pretend otherwise.
	* You are smart; but don't be a space-human.
14. Precede trends with honesty
	* Don't bet your great ideas on a fad
	* Your new idea could become a trend.
15. Who benefits more from the data you volunteer?
	* You or (Microsoft, Apple, Google, Facebook, Amazon)?
16. Who has steered you astray regarding infotech?
