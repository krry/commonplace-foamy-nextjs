...
When I consider my own wants and needs—which to fulfill first, which to eschew or delay—I often end up attempting to stack them in a list or hierarchy *a la* Maslow.
