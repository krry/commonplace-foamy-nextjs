...
1. Causality
   ...
   - past => present => future
2. Eternity
   - the shot or the chain
   - real
   - this is, this too will pass
   - always as it will have been
3. Entirety
   - the target or the cloud
   - possible
   - all these may have been
4. Intention
   - the draw (tension) or intensity
   - easier
   - _this_ is the way
5. Impact
   - the hit or the strike
   - echoes
   - density or momentum
   - this valley deepens, the groove wears
